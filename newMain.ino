...
#define FADE_DELAY 200 // Delay for fading in milliseconds
...
void loop() {
  ...
  for (int i = 0; i < sizeof(acceleration) / sizeof(acceleration[0]); i++) {
    fade_to_pattern(acceleration[i], 5); // 5 fade steps
